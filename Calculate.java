...
/**
 * Class to interpret and compute the result of arithmetic expressions in INFIX
 * format -
 *
...
public class Calculate {
  ...
  /**
   * Determining the operator priority level. Level 1 is + and -. Level 2 is * and
   * /. Level 3 is ^.
   *
   ...
   * @throw Exception Mismatched parathesis in infix expression.
   */
    ...
    while (scanner.hasNext()) {
      ...
      // If token is outside of scope
        ...
        throw new ArithmeticException(
            "ERROR: Invalid input. Please don't include non numeric or non operative symbols.");
      }
    }
